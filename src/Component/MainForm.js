            ...
            <div className="start-form">
                ...
                <div className="form-elems">
                    <div className="company-name">
                        ...
                        <input type="text" value="apple" onChange={(e) => { setLocaldata({ ...localData, company: e.target.value }) }} placeholder="Your beautiful company name."></input>
                    </div>
                    <div className="textarea">
                        <label className="block-display">CSV Transaction text</label>
                        <textarea onChange={(e) => { setLocaldata({ ...localData, csv: e.target.value }) }} rows="10" placeholder="CSV text"> </textarea>
                    </div>
